...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [1493357.699852, 5800999.926862, 1614783.431063, 5866254.511562], maxZoom: 20, minZoom: 10
    })
});
...
map.getView().fit([1493357.699852, 5800999.926862, 1614783.431063, 5866254.511562], map.getSize());
